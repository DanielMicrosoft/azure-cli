...
class Create(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        # define Arg Group "Profile.properties.logScrubbing"

        _args_schema = cls._args_schema
        _args_schema.scrubbing_rules = AAZListArg(
            options=["--scrubbing-rules"],
            arg_group="Profile.properties.logScrubbing",
    ...
    class ProfilesGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _CreateHelper._build_schema_profile_read(cls._schema_on_200)
    ...
    class InstanceCreateByJson(AAZJsonInstanceCreateOperation):
        ...
        def _create_instance(self):
            ...
            _builder.set_prop("scrubbingRules", AAZListType, ".scrubbing_rules")
            _builder.set_prop("state", AAZStrType, ".state")

            scrubbing_rules = _builder.get(".scrubbingRules")
            if scrubbing_rules is not None:
                scrubbing_rules.set_elements(AAZObjectType, ".")

            _elements = _builder.get(".scrubbingRules[]")
