...
@register_command(
    "healthcareapis deidservice identity assign",
)
class Assign(AAZCommand):
    ...
    class DeidServicesGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _AssignHelper._build_schema_deid_service_read(cls._schema_on_200)
    ...
    class DeidServicesCreate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _AssignHelper._build_schema_deid_service_read(cls._schema_on_200_201)
